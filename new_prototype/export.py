...
for start, end, data in G.edges(data=True):
    ...
    if data["reversed"]:
        data["osmid"] += "r"
    #print(data["length"] * 1.4792 - math.sqrt((export["nodes"][str(start)]["pos"][0] - export["nodes"][str(end)]["pos"][0]) ** 2 + (export["nodes"][str(start)]["pos"][1] - export["nodes"][str(end)]["pos"][1]) ** 2))
